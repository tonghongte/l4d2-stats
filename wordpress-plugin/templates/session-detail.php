...
<div class="l4d2-stats-container">
    ...
    <div class="l4d2-session-header">
        ...
        <div class="l4d2-session-info">
            ...
            <div class="l4d2-player-meta">
                <span>開始: <?php echo wp_date('Y-m-d H:i:s', \L4D2Stats\Plugin::mysql_utc($session->start_time)); ?></span>
                <?php if ($session->end_time): ?>
                    <span>結束: <?php echo wp_date('Y-m-d H:i:s', \L4D2Stats\Plugin::mysql_utc($session->end_time)); ?></span>
                <?php endif; ?>
